...
#include <encoder_monitor.hpp>
#include <turn_only_encoder.hpp>
...
private:
  ...
  // Control Instances
  std::array<TurnOnlyEncoder, ENCODER_COUNT> encoders_;
